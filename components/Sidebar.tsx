      ...
      <div className={`flex-1 overflow-y-auto scrollbar-hide ${open ? '' : 'hidden'}`}>
        <nav className="flex flex-col py-1">
          ...
          {!inStudio && !inProfile && !inAdmin && (
            <Link href="/map" className={row(pathname.startsWith('/map'))} title="MAP">
              <span className={iconCol}><svg viewBox="0 0 24 24" className={ICON} {...stroke}><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3c2.5 3 2.5 15 0 18M12 3c-2.5 3-2.5 15 0 18" /></svg></span>
