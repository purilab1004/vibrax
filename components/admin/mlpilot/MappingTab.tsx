...
import { Card, Badge, SectionTitle, Segmented, Skeleton, Toggle, Toast, Modal, btn, input, label as labelCls, th, td, trHover } from '@/components/admin/ui'
...
export default function MappingTab() {
  ...
  const header = <div className="flex items-center justify-between gap-2 mb-3"><p className="text-[12.5px] text-[#6b7280]">프롬프트를 LLM 대신 자체 템플릿으로 매핑(원가 0). 키워드 + 유사도 + AI 판단.</p><Segmented value={days} onChange={setDays} options={[{ value: 7, label: '7일' }, { value: 30, label: '30일' }, { value: 90, label: '90일' }]} /></div>
