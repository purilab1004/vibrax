...
export const t = {
  ko: {
    ...
    studio: {
      ...
      offTopic: '게임 제작과 관련된 요청만 입력할 수 있어요. 만들고 싶은 게임이나 수정할 내용을 알려주세요! (크레딧은 차감되지 않았습니다)',
  ...
  en: {
    ...
    hero: {
      ...
      showcaseBadge: 'VIBREX STUDIO',
      showcaseHeading: 'Featured prompts',
    },
    games: {
      heading: 'GAMES',
      liveNow: 'LIVE NOW',
      ...
      hoverMsgs: [
        ...
        'This one is so fun 🍯',
        'Press it and see?!',
        'Just one try~ trust me',
        'Click if you dare lol',
        'Beat the high score!',
        'Bored? Perfect timing 😎',
      ],
    ...
    studio: {
      ...
      offTopic: 'Only game-related prompts are accepted. Tell me what game to build or change! (No credits were charged)',
      publishHeading: 'PUBLISH GAME',
