...
const VARIANTS: Record<string, { replace: string[]; titles: Variant[] }> = {
  tetris: { replace: ['NEON TETRIS', '네온 테트리스'], titles: [
    { title: '네온 블록 스택', en: 'NEON BLOCK STACK' }, { title: '블록 폭풍', en: 'BLOCK STORM' }, { title: '루미노 스택', en: 'LUMINO STACK' }, { title: '사이버 블록스', en: 'CYBER BLOX' }, { title: '그리드 러시', en: 'GRID RUSH' }, { title: '픽셀 타워', en: 'PIXEL TOWER' }, { title: '스타 스태커', en: 'STAR STACKER' }, { title: '오로라 블록', en: 'AURORA BLOCKS' },
  ] },
