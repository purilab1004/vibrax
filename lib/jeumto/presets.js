...
export const PRESETS = [
  { id: 'square', label: '둥근 사각', emoji: '🟪', base: { ...D }, color: '#7fd8e6' },
  ...
  { id: 'bun', label: '납작빵', emoji: '🍞', base: { width: 2.3, height: 1.8, depth: 2.0, radius: 0.75 }, color: '#ffb47a' },
  { id: 'tall', label: '길쭉이', emoji: '🧱', base: { width: 1.7, height: 2.9, depth: 1.6, radius: 0.55 }, color: '#8fb8ff' },
  ...
  { id: 'bear', label: '곰귀', emoji: '🐻', base: { width: 2.1, height: 2.2, depth: 1.9, radius: 0.85 }, color: '#c98a5a',
    strokes: [
  ...
  { id: 'cat', label: '고양이귀', emoji: '🐱', base: { width: 2.1, height: 2.1, depth: 1.8, radius: 0.7 }, color: '#ffd166',
    strokes: [
      { brush: 'pull', at: [0.7, 0.95, 0], dir: [0.4, 1, 0], radius: 0.42, amount: 0.08, steps: 20, advance: 0.03, symmetry: true },
    ] },
  { id: 'horn', label: '뿔', emoji: '🦄', base: { ...D, radius: 0.7 }, color: '#b39ddb',
    strokes: [
