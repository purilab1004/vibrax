  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100vh - 3.5rem)' }}>
      <div className="flex items-center gap-4 border-b border-[#ebe4d6] px-4 py-2 shrink-0">
        <Link
          href="/studio"
          className="font-pixel text-[11px] text-[#6b6152] hover:text-[#0284c7] tracking-widest transition-colors shrink-0"
        >
          {s.backToStudio}
        </Link>
        ...
        <Link
          href="/credits"
          className="font-pixel text-[11px] text-[#0284c7] tracking-widest shrink-0 hover:underline"
        >
          {s.balance(balance ?? 0)}
        </Link>
      </div>
