  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
        <p className="font-pixel text-[#00ff41] text-[11px] tracking-[0.4em] mb-6">{a.badge}</p>
        ...
        {phases.map((p, i) => {
          ...
          return (
            <div key={i} className={`border-l-2 ${accent.border} pl-8 py-12 relative`}>
              ...
              <p className="font-pixel text-[11px] text-gray-500 tracking-widest mb-6">{p.label}</p>
      ...
      <div className="max-w-3xl mx-auto px-6 pb-20">
        <div className="border border-[#00ff41]/30 bg-[#00ff41]/5 p-8 md:p-12 text-center">
          <p className="font-pixel text-[#00ff41] text-[11px] tracking-widest mb-6">{a.s5.label}</p>
