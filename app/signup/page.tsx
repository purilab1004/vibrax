  ...
  return (
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        {message ? (
          <div className="border border-[#0e7573]/30 bg-[#0e7573]/5 p-6 text-center">
            <p className="font-pixel text-[#0e7573] text-[11px] mb-3">{a.sent}</p>
            <p className="text-[#4a4337] text-sm leading-relaxed">{message}</p>
            <Link
              href="/login"
              className="inline-block mt-4 text-xs text-[#6b6152] hover:text-[#0e7573] transition-colors"
            >
              {a.toLogin}
            </Link>
          </div>
        ...
        <p className="text-center text-xs text-[#4a4337] mt-6">
          {a.hasAccount}{' '}
          <Link href="/login" className="text-[#0e7573] hover:underline">
            LOGIN
          </Link>
        </p>
      </div>
