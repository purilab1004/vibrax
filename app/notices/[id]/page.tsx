...
export default function NoticePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (notice === null) {
    return (
      <div className="max-w-3xl mx-auto px-6 py-20 text-center">
        ...
        <Link href="/notices" className="font-pixel text-[11px] text-[#0284c7] tracking-widest">{n.back}</Link>
      </div>
    )
  }
  ...
  return (
    <article className="max-w-3xl mx-auto px-6 py-10">
      <Link href="/notices" className="font-pixel text-[11px] text-[#857a68] hover:text-[#0284c7] tracking-widest">← {n.back}</Link>
